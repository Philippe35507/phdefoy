...
Le [locatif](/le-cas-locatif-en-russe-philippe-de-foy-prepositionnel/) (parfois appelé prépositionnel) s'utilise toujours avec une préposition pour exprimer la localisation ou le sujet d'une conversation. Les prépositions les plus courantes sont **в** (dans) et **на** (sur).
...
Le [génitif](/cas-genitif-singulier-en-russe-philippe-de-foy/) est l'un des cas les plus polyvalents du russe. Il exprime la possession, la provenance, l'absence, et s'utilise après certaines prépositions et avec les quantités.
...
Cette leçon introduit l'un des concepts les plus caractéristiques du russe : [l'aspect verbal en Russe](/l-aspect-des-verbes-en-russe-guide-complet/). Chaque verbe russe existe généralement en deux versions — perfective et imperfective — qui expriment non seulement quand se passe l'action, mais surtout comment elle se déroule.
...
1. Comment se déplace-t-on ? (À pied, en véhicule, en courant, en volant, en nageant, en portant quelque chose ?)
2. S'agit-il d'un mouvement dans une direction précise (en ce moment) ou d'un mouvement habituel/multidirectionnel ?
