...
description: "Maîtrisez l'accusatif pluriel russe avec ce guide complet pour francophones. Règles, terminaisons, exceptions et exercices corrigés. Passage du niveau A2 au B1."
pubDate: "Jan 15, 2026"
...
- Я ви́жу **краси́вые дома́** (Je vois de belles maisons)
...
Les adjectifs s'accordent avec les noms qu'ils qualifient. À  l'accusatif pluriel, contrairement aux noms, les adjectifs ne varient qu'en fonction de l'animéité du nom, sans distinction de genre :

- Pour les NOMS : les terminaisons dépendent du genre ET de l'animéité
  - столы́, кни́ги, о́кна (genres différents, tous inanimés)
  - студе́нтов, де́вушек, живо́тных (genres différents, tous animés)

- Pour les ADJECTIFS : une seule forme par animéité, quel que soit le genre
...
Pour les apprenants de niveau B1, il est recommandé de toujours traiter les noms d'animaux comme animés, sauf dans des contextes très spécifiques.
...
- Я чита́ю **газе́ты** (Je lis des journaux - inanimé)
- Мы встреча́ем **госте́й** (Nous accueillons des invités - animé)
- Она́ пи́шет **письма́** (Elle écrit des lettres - inanimé)
- Они́ пригласи́ли **колле́г** (Ils ont invité des collègues - animé)

Les verbes les plus courants qui gouvernent l'accusatif sont : **ви́деть** (voir), **чита́ть** (lire), **писа́ть** (écrire), **лю́бить** (aimer), **знать** (connaître), **встреча́ть** (rencontrer), **покупа́ть** (acheter).
...
- Студе́нты пошли́ **в библиоте́ки** (Les étudiants sont allés dans les bibliothèques)

Attention : si la préposition exprime une localisation statique (où ?) et non un mouvement (vers où ?), on utilise le locatif et non l'accusatif.
...
Cette règle surprend souvent les francophones, mais elle est absolue en russe. Seuls les nombres se terminant par **оди́н** (один, два́дцать оди́н, тридцать оди́н...) sont suivis de l'accusatif.
