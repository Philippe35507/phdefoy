...
- Terminaison en consonne molle ou **-й** → **-и** : слова́рь (dictionnaire) → словари́ ; музе́й (musée) → музе́и
...
- masculins terminés par **-й** → **-ев** : геро́й (héros) → геро́ев
...
- Terminaison en **-я** → **-ь** :  тётя (tante) → тёть
- Terminaison en  **-ь** → **-ей** : ло́шадь (cheval) → лошаде́й
...
-Он ви́дит **лошаде́й** (Il voit des chevaux).
